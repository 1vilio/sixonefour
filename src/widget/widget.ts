document.addEventListener('DOMContentLoaded', () => {
    ...
    const progressFill = document.getElementById('widget-progress-fill') as HTMLElement;
    ...
    const videoBg = document.getElementById('widget-video-bg') as HTMLVideoElement;
