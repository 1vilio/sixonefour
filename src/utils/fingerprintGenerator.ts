...
const FINGERPRINTS: FingerprintDefinition[] = [
    // Windows Desktop (Chrome/Edge)
    {
        ...
        os: 'windows', type: 'desktop', platform: 'Win32'
    },
    {
    ...
    // MacOS Desktop (Chrome/Safari)
    {
        ...
        os: 'macos', type: 'desktop', platform: 'MacIntel'
    },
    {
    ...
    // iOS Mobile (Safari)
    {
        ...
        os: 'ios', type: 'mobile', platform: 'iPhone'
    },
    {
    ...
    // Android Mobile (Chrome)
    {
        ...
        os: 'android', type: 'mobile', platform: 'Linux armv8l'
    },
    {
